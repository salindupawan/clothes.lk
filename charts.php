                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="#!" onclick="test();">Dashboard</a></li>
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-12 col-lg-3">
                                        <div class="card bg-success text-white mb-4" onclick="addProductModal();">
                                                                    ...
                                                                    <div class="row ">
                                                                        ...
                                                                        <div class="col-12 mt-3 mb-3">
                                                                            <div class="row">
                                                                                <div class="col-6 col-lg-4 offset-3 offset-lg-4 d-grid">
                                                                                    ...
                                                                                    <label for="imageuploader" class="btn btn-outline-dark rounded rounded-5" onclick="changeProductImageAddProduct();">Upload Images</label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-6  mt-3">
                                                                            ...
                                                                            <select class="form-select form-select-sm" id="brand">
                                                                                ...
                                                                                ?>
                                                                                    <option value="<?php echo $brand_data["id"] ?>"><?php echo $brand_data["b_name"] ?></option>
                                                                        ...
                                                                        <div class="col-6 mt-3">
                                                                            ...
                                                                            <select class="form-select form-select-sm" id="colour">
                                                                        ...
                                                                        <div class="col-12 col-lg-12 mt-3">
                                                                            ...
                                                                            <input type="text" class="form-control form-control-sm" id="pid">
                                                                        </div>
                                                                        <div class="col-12">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-4 col-lg-4 mt-3">
                                                                                    ...
                                                                                    $s_num = $s_rs->num_rows;
                                                                                    for ($sr = 0; $sr < $s_num; $sr++) {
                                                                                        $s_data = $s_rs->fetch_assoc();
                                                                                    ?>
                                                                                        <div class="form-check">
                                                                                            <input class="form-check-input" type="checkbox" id="s<?php echo $s_data["id"] ?>">&nbsp;
                                                                                            <label class="form-check-label" for="flexCheckDefault1">
                                                                                                <?php echo $s_data["name"] ?>
                                                                                            </label>
                                                                                        </div>
                                                                                    <?php
                                                                                    }
                                                                                ...
                                                                                <div class="col-8 col-lg-8">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-12  mt-3">
                                                                                            ...
                                                                                            <input type="number" min="1" id="qty" value="1" class="form-control form-control-sm">
                                                                                        </div>
                                                                                        <div class="col-12  mt-3">
                                                                                            <label class="form-label fw-bold">Price</label>
                                                                                            <div class="input-group input-group-sm ">
                                                                                                <span class="input-group-text">Rs.</span>
                                                                                                <input type="text" id="price" class="form-control form-control-sm" aria-label="Amount (to the nearest dollar)">
                                                                                        ...
                                                                                        <div class="col-12  mt-3">
                                                                                            ...
                                                                                            <div class="input-group input-group-sm ">
                                                                                                <span class="input-group-text">Rs.</span>
                                                                                                <input type="text" class="form-control form-control-sm" id="delivery" aria-label="Amount (to the nearest dollar)">
                                                                                                <span class="input-group-text">.00</span>
                                                                                            </div>
                                                                                        </div>
                                                                        ...
                                                                        <div class="col-12 mt-3">
                                                                            ...
                                                                            <textarea cols="30" rows="10" id="des" class="form-control form-control-sm"></textarea>
                                                                        </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        <div class="row">
                                                            <div class="col-12 text-start">
                                                                <small class="text-danger" id="addProductResponse"></small>
                                    ...
                                    <div class="col-12 col-lg-3">
                                        <div class="card bg-primary text-white mb-4" onclick="addSubcategory();">
                                        ...
                                        <!-- model 3-->
                                        <div class="modal" tabindex="-1" id="addSubcategory">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body p-4">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            $addCategroy_rs = Database::search("SELECT * FROM `category`");
                                                            $addCategroy_num = $addCategroy_rs->num_rows;

                                                            for ($add = 0; $add < $addCategroy_num; $add++) {
                                                                $addCategroy_data = $addCategroy_rs->fetch_assoc();
                                                            ?>
                                                                ...
                                                                <div class="col-12 my-2">
                                                                    <p>
                                                                        ...
                                                                        <button class="btn btn-sm btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample<?php echo $addCategroy_data["id"] ?>" aria-expanded="false" aria-controls="collapseExample<?php echo $addCategroy_data["id"] ?>">
                                                                            <?php echo $addCategroy_data["c_name"] ?> &nbsp; <i class="bi bi-caret-down-fill"></i>
                                                                        </button>
                                                                    </p>
                                                                    <div class="collapse" id="collapseExample<?php echo $addCategroy_data["id"] ?>">
                                                                        <div class="card card-body" id="card<?php echo $addCategroy_data["id"] ?>">
                                                                            <?php
                                                                            $addSubCategory_rs = Database::search("SELECT * FROM `sub_category` WHERE `category_id`='" . $addCategroy_data["id"] . "'");
                                                                            $addSubCategory_num = $addSubCategory_rs->num_rows;

                                                                            for ($s = 0; $s < $addSubCategory_num; $s++) {
                                                                                $addSubCategory_data = $addSubCategory_rs->fetch_assoc();
                                                                            ?>
                                                                                <h6><?php echo $s + 1; ?>. <?php echo $addSubCategory_data["name"] ?></h6>
                                                                        ...
                                                                        <div class="row mt-2">
                                                                            <div class="col-10">
                                                                                <input type="text" onkeyup="removeResponseText(<?php echo $addCategroy_data['id'] ?>);" placeholder="Add New One" value="" id="<?php echo $addCategroy_data["id"] ?>" class="form-control form-control-sm">
                                                                            </div>
                                                                            <div class="col-2 d-grid ">

                                                                                <button class="btn btn-sm btn-outline-primary" id="b<?php echo $addCategroy_data["id"] ?>" onclick="addSubcategorydata(<?php echo $addCategroy_data['id'] ?>);">Add</button>
                                                                            </div>
                                                                            <div class="col-12">
                                                                                <small class="text-danger" id="r<?php echo $addCategroy_data["id"] ?>"></small>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                    ...
                                    <div class="col-12 col-lg-3 d-none">
                                        <div class="card bg-secondary text-white mb-4" onclick="updateSubImages();">
                                            <div class="card-body">Update Sub Category Images</div>
                                            <div class="card-footer d-flex align-items-center justify-content-between">
                                                <a class="small text-white stretched-link" href="#"></a>
                                                <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                            </div>
                                        ...
                                        <!-- model 3-->
                                        <div class="modal" tabindex="-1" id="updateSubImages">
                                            <div class="modal-dialog modal-dialog-scrollable">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Update Sub Category Images</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                            ...
                                                            ?>
                                                                ...
                                                                <div class="col-12 my-2">
                                                                    <p>
                                                                        ...
                                                                        <button class="btn btn-sm btn-secondary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample<?php echo $c_data["id"] ?>" aria-expanded="false" aria-controls="collapseExample<?php echo $c_data["id"] ?>">
                                                                            <?php echo $c_data["c_name"] ?> &nbsp; <i class="bi bi-caret-down-fill"></i>
                                                                        </button>
                                                                    </p>
                                                                    <div class="collapse" id="collapseExample<?php echo $c_data["id"] ?>">
                                                                        <div class="card card-body">
                                                                            <div class="row">
                                                                                <div class="col-12">
                                                                                    <select name="" id="s<?php echo $c_data["id"] ?>" onchange="loadSubCatImage(<?php echo $c_data['id'] ?>);" class="form-select form-select-sm">
                                                                                        <option value="0">Select Sub Category</option>
                                                                                        <?php
                                                                                        $sub_rs = Database::search("SELECT * FROM `sub_category` WHERE `category_id`='" . $c_data["id"] . "'");
                                                                                        $sub_num = $sub_rs->num_rows;
                                                                                        for ($su = 0; $su < $sub_num; $su++) {
                                                                                ...
                                                                                <div class="col-12" >
                                                                                    <div class="row" id="imgdiv<?php echo $c_data["id"] ?>">
                                    ...
                                    <div class="col-12 col-lg-3">
                                        <div class="card bg-light text-black mb-4" onclick="addColour();">
                                            <div class="card-body">Add Colour </div>
                                            <div class="card-footer d-flex align-items-center justify-content-between">
                                                <a class="small text-black stretched-link" href="#"></a>
                                                <div class="small text-black"><i class="fas fa-angle-right"></i></div>
                                            </div>
                                        </div>
                                        <!-- model 3-->
                                        <div class="modal" tabindex="-1" id="addColour">
                                            <div class="modal-dialog modal-dialog-scrollable">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12 my-2">
                                                                ...
                                                                <div class="">
                                                                    <div class="card card-body">
                                                                        <?php 
                                                                        $colourAD_rs = Database::search("SELECT * FROM `colour`");
                                                                        $colourAD_num = $colourAD_rs->num_rows;

                                                                        for($co=0;$co<$colourAD_num;$co++){
                                                                            $colourAD_data = $colourAD_rs->fetch_assoc();
                                                                            ?>
                                                                            <h6><?php echo $co +1;  ?>. <?php echo $colourAD_data["name"] ?></h6>
                                                                            <?php
                                                                        }
                                                                    ...
                                                                    <div class="row mt-2">
                                                                        <div class="col-10">
                                                                            <input type="text" onkeyup="removeResponseTextFromColour();" placeholder="Add New One" id="colourInput" class="form-control form-control-sm">
                                                                        </div>
                                                                        <div class="col-2 d-grid ">
                                                                            <button class="btn btn-sm btn-outline-primary" onclick="addColourdata();">Add</button>
                                                                        </div>
                                                                        <div class="col-12 mt-2 text-end">
                                                                            <small class="text-danger" id="colourR"></small>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                    ...
                                    <div class="col-12 col-lg-3">
                                        <div class="card bg-warning text-white mb-4" onclick="stocklt10();">
                                            <div class="card-body">Stock Less than 10 (09)</div>
                                            <div class="card-footer d-flex align-items-center justify-content-between">
                                        ...
                                        <!-- model 3-->
                                        <div class="modal " tabindex="-1" id="stocklt10">
                                            <div class="modal-dialog modal-dialog-scrollable">
                                                <div class="modal-content ">
                                                    <div class="modal-header bg-warning">
                                                        <h5 class="modal-title text-white">Stock Less than 10</h5>
                                                    ...
                                                    <div class="modal-body px-2">
                                                        ...
                                                        <div class="row ">
                                                            <div class="col-6 p-2">
                                                                <div class="card ">
                                                                    <img src="resources/gf1.jpg" class="card-img-top p-3" alt="...">
                                                                    <div class="card-body">
                                                                        <small class="card-title text-black fw-bold  text-decoration-underline">Deedat Longsleeves p43a2 </small><br>
                                                                        <small class="fw-bold text-black-50">Rs. 1250.00</small><br> <br>
                                                                        <small class="text-black-50">Deedat-fr09</small> <br>
                                                                        <small class="text-black-50">Qty : 12</small>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-6 p-2">
                                    ...
                                    <div class="col-12 col-lg-3">
                                        <div class="card bg-danger text-white mb-4" onclick="outofStock();">
                                            <div class="card-body">Out Of Stock (12)</div>
                                            <div class="card-footer d-flex align-items-center justify-content-between">
                                                <a class="small text-white stretched-link" href="#">View Details</a>
                                                <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                            </div>
                                        ...
                                        <!-- model 3-->
                                        <div class="modal " tabindex="-1" id="outofStock">
                                            <div class="modal-dialog modal-dialog-scrollable">
                                                <div class="modal-content ">
