...
if (isset($_SESSION["au"])) {
    ...
    $subCategory_rs = Database::search("SELECT sub_category.id AS id, sub_category.name AS name,sub_category.category_id AS cid FROM `sub_category` INNER JOIN `category` ON sub_category.category_id=category.id WHERE `category_id`='6'");
    $cid_rs = Database::search("SELECT sub_category.id AS id, sub_category.name AS name,sub_category.category_id AS cid FROM `sub_category` INNER JOIN `category` ON sub_category.category_id=category.id WHERE `category_id`='6'");
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <h1 class="mt-4">Personal Care</h1>
                        ...
                        <div class="row">
                            <div class="col-5 col-lg-4">
                                ...
                                <select  id="changeSubCategory" class="form-select " onchange="changeSubCategory(<?php echo $cid_data['cid'] ?>);">
                                    ...
                                    <option value="0">Personal Care all Product</option>
                                    <?php
