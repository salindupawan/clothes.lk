...
if (isset($_SESSION["au"])) {
    ...
    $subCategory_rs = Database::search("SELECT sub_category.id AS id, sub_category.name AS name,sub_category.category_id AS cid FROM `sub_category` INNER JOIN `category` ON sub_category.category_id=category.id WHERE `category_id`='5'");
    $cid_rs = Database::search("SELECT sub_category.id AS id, sub_category.name AS name,sub_category.category_id AS cid FROM `sub_category` INNER JOIN `category` ON sub_category.category_id=category.id WHERE `category_id`='5'");
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="row">
                            <div class="col-5 col-lg-4">
                                ...
                                <select  id="changeSubCategory" class="form-select " onchange="changeSubCategory(<?php echo $cid_data['cid'] ?>);">
                                    ...
                                    <option value="0">Home & Decor all Product</option>
                                    <?php
                        ...
                        <li><a class="dropdown-item" href="#">Sleeveless</a></li>
                    </ul>
                 -->
                                </select>
